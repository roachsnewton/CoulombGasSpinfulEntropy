...
class FermiNet_spin(hk.Module):
    def __init__(self, depth, spsize, tpsize, L, init_stddev=0.01, remat: bool = False,):
        super().__init__()
        self.depth = depth
        self.L = L
    ...
    def _tpstream0(self, x):
        ...
        return jnp.concatenate((cos_rij, sin_rij, dij_sin[..., None]), axis=-1)
